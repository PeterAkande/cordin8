...
org_table_name = "C8-ORG-TABLE"
department_table = "C8-DEPARTMENT-TABLE"
task_table = "C8-TASKS-TABLE"
task_table = "C8-TASKS-TABLE"
orgs_user_table = "C8-ORG-USER-TABLE"
invitations_table = "C8-INVITATIONS-TABLE"
